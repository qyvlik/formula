...
import io.github.qyvlik.formula.modules.formula.service.impl.FormulaCalculatorSafeImpl;
...
//    }
    ...
    public FormulaCalculator formulaCalculator(
            @Autowired FormulaVariableServiceImpl formulaVariableService) {
        FormulaCalculatorSafeImpl formulaCalculator = new FormulaCalculatorSafeImpl();
