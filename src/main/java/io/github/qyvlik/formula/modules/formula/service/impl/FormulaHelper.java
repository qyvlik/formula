...
public final class FormulaHelper {
    ...
    private static final List<String> blackKeywords = ImmutableList.of(
     ...
     * @return
     */
    private static double getWeight(String currency) {
    ...
    public static FormulaResult convert(FormulaVariableService formulaVariableService,
                                        String from, String to, BigDecimal fromValue) {
...
//                }
    ...
    public static void validateVariable(String formula, String variable) {
